...
class PerfMetric(BaseModel):
    ...
    retrieve_time: Optional[float] = Field(default=None, description="Time taken for retrieval in seconds (deprecated, use similarity_retrieve_time)")
    rerank_time: Optional[float] = Field(default=None, description="Time taken for reranking in seconds (deprecated, use similarity_rerank_time)")
    similarity_retrieve_time: Optional[float] = Field(default=None, description="Time taken for similarity search retrieval in seconds")
    similarity_rerank_time: Optional[float] = Field(default=None, description="Time taken for similarity search reranking in seconds")
    similarity_total_time: Optional[float] = Field(default=None, description="Total time for similarity search in seconds")
