...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/datasources/{id}/services": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Connected services with live sync state",
                        "schema": {
                            "$ref": "#/definitions/github_com_project-ai-services_ai-services_internal_pkg_catalog_apiserver_models.DatasourceServicesResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid UUID format",
    ...
    "definitions": {
        ...
        "github_com_project-ai-services_ai-services_internal_pkg_catalog_apiserver_models.DatasourceServicesResponse": {
            "type": "object",
            "properties": {
                "datasource_id": {
