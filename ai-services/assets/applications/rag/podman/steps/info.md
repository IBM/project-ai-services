...
- Digitize UI is unavailable to use. Please make sure '{{ .AppName }}--digitize' pod is running.
{{- end }}
{{- end }}
...
- Digitize API is unavailable to use. Please make sure '{{ .AppName }}--digitize' pod is running.
{{- end }}
{{- end }}
