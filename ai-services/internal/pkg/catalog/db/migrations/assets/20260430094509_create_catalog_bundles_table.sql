...
-- Reuse the update_updated_at_column() trigger function created in
-- 20260430094502_create_applications_table.sql.
...
-- +goose Down
-- +goose StatementBegin
DROP TRIGGER  IF EXISTS set_updated_at ON catalog_bundles;
