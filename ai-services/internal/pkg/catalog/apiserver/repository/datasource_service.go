...
func NewDatasourceService(
	...
	serviceDependency dbrepo.ServiceDependencyRepository,
	...
	return datasourceservice.NewDatasourceService(connectorRepo, serviceDependency, validator, provider, encryptionKey), nil
}
