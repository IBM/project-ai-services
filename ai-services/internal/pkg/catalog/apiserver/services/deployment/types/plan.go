...
type ComponentPlan struct {
	...
	Values         map[string]interface{} // Structured values from LoadComponentValues
...
type ServicePlan struct {
	...
	Values        map[string]interface{} // Structured values from LoadServiceValues + component values
}
